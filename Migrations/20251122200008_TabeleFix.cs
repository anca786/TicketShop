        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wishlists_AspNetUsers_UtilizatorId",
                        column: x => x.UtilizatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EvenimenteId = table.Column<int>(type: "int", nullable: false),
                    WishlistId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvenimentWishlist", x => new { x.EvenimenteId, x.WishlistId });
                    table.ForeignKey(
                        name: "FK_EvenimentWishlist_Evenimente_EvenimenteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvenimentWishlist_WishlistId",
                table: "EvenimentWishlist",
                column: "WishlistId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_EvenimentId",
                table: "Reviews",
                column: "EvenimentId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_UtilizatorId",
                table: "Reviews",
                column: "UtilizatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_UtilizatorId",
                table: "Wishlists",
                column: "UtilizatorId",
                unique: true);
        }
